...
\begin{proposition}{Equazione di Eulero--Lagrange debole}{E-L debole}
    Nella situazione \ref{situazione E-L}, se $u_0$ è un punto di minimo allora per ogni $\varphi \in \mc{C}_c^1(]a,b[)$ soddisfa l'\bemph{equazione di Eulero--Lagrange debole}:

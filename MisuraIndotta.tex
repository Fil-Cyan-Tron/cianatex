...
Cercheremo di dimostrare il TFA per cambiamenti di coordinate \bemph{lineari} con la speranza di estendere questo ragionamento a cambiamenti di coordinate \bemph{differenziabili}, ovvero localmente lineari.

\begin{lemma}{Cambiamenti di coordinate lineari e misura elementare dei plurirettangoli}{}
    Sia $\mc{I} \subset 2^{\R^n}$ la famiglia degli $n$-plurirettangoli aperti, sia $e : \mc{I} \to \R_+$ la misura elementare e sia $f : \R^n \to \R^n$ una mappa lineare invertibile.\\
    Allora $e(f(I)) = |\det f| \cdot e(I)$ per ogni $I \in \mc{I}$.
    \begin{proof}
        Qualsiasi plurirettangolo $I$ è biunivocamente corrispondente a un segmento di $\R^n$ visto come spazio affine con la mappa
        \[ ]a_[ \]
    \end{proof}
\end{lemma}

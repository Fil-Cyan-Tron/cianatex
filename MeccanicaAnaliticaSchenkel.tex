...
Specializzandoci ulteriormente con una scelta di coordinate, vediamo che una linea di universo $\gamma$ è determinata da una curva liscia $\vec{\gamma}$ in $\R^3$; adottando questo punto di vista, l'azione degli automorfismi sulle linee di universo può essere calcolata esplicitamente: dato un automorfismo $(F,f)$ con $f: t\mapsto c+at$ e $F: (t,\vec x)\mapsto (c+at, \vec b(t) + R(t)\vec x )$ , vediamo che $F\circ\gamma\circ f^{-1}$ è dato dalla mappa $t' \mapsto (t', \vec b(-ac +at') + R(-ac+at')\vec \gamma (-ac +at') )$ che ci permette di trasformare $\vec \gamma : I \to \R^3$ in $\vec \gamma' : aI+c \to \R^3$
...
\begin{definition}{Velocità e accelerazione rispetto a un riferimento}{velocità e accelerazione}
    ...
    E definiamo l'\bemph{accelerazione} come 

...
%\setbeameroption{show notes} % Both only in slides with notes
...
\title{UniTn Beamer Presentation Theme}
\subtitle{Using \LaTeX\ to prepare slides}
\course{Bachelor's Degree in Mathematics}
\author{\href{mailto:davide.borra@studenti.unitn.it}{Davide Borra}}
\IDnumber{1234567}

\begin{document}
%\AtBeginNote{\insertslideintonotes{0.5}}
\maketitle
...
\begin{frame}[fragile]{Getting Started}
      ...
      \note{
            Paperino, Topolino e Marco Andreatta stanno ceracando un vicolo delle Albere libero.
      }

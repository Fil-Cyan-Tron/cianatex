...
\addbibresource{PEM-Troncana.bib}
...
\begin{proposition}{Proprietà degli universi di Grothendieck più che numerabili}{proprietà degli universi di Grothendieck più che numerabili}
    Sia $\G$ un universo di Grothendieck più che numerabile. Allora questo contiene:\begin{itemize}
        ...
        \item Tutte le cardinalità strettamente minori della sua.
...
\begin{remark}{Sull'assioma di Universo debole}{sull'assioma di universo debole}
    ...
    \end{axiom}
    Questo implica l'esistenza di tutta una gerarchia di  è utile per trattare la Teoria delle Categorie Superiori, ma per una trattazione più elementare è sufficiente assumere l'esistenza di un solo universo, si veda \cite{MacLane1969}.
\end{remark}
